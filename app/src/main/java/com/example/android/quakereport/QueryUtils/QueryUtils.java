package com.example.android.quakereport.QueryUtils;

import android.util.Log;

import com.example.android.quakereport.QuakeInfo;
        ...
        public static ArrayList<QuakeInfo> extractEarthquakes() {
            ...
            try {
                ...
                for (int i = 0; i< earthquakeArray.length(); i++){
                    ...
                    QuakeInfo earthquake = new QuakeInfo(magnitude,location,time, url);
